                  ...
                  <div style="text-align: center;">
                    <form id="upload-form" enctype="multipart/form-data">
                      <label for="file-upload" class="btn btn-primary btn-border"
                        style="border-radius: 50px; padding: 10px 20px;">Upload Logo</label>
                ...
                <div style="flex: 3;">
                  <div class="overflow-hidden">
                    <div class="card-body p-4">
                      <form id="data-form">
                        <div class="mb-3">
                          <label for="startupType" class="form-label">News Headline</label>
                          <input type="text" class="form-control" id="startupType" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                          <label for="startupName" class="form-label">Short Description </label>
                          <input type="text" class="form-control" id="startupName">
                        </div>
                        <div class="mb-3">
                          <label for="websiteURL" class="form-label">News URL</label>
